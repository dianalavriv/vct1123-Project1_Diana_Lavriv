...
function getArtist() {
    ...
    for (let i = 0; i < sections.length; i++) {
      ...
      artistList += '</table>';
      artistList += '<p><img src="' + allArtists[i].albumImg + '" alt="' + allArtists[i].album + '"></p>';
...
let artist1 = new Artist('Autechre', 'Tri Repetae', 'Warp Records', 1995, 'images/quaristice_.jpeg', 
...
let artist2 = new Artist('Aphex Twin', 'Selected Ambient Works 85-92', 'Apollo Records', 1992, 'images/richardDJames.jpeg', 
...
let artist3 = new Artist('Future Sound of London', 'Lifeforms', 'Arista Records', 1994, 'images/deadCities.jpeg', 
...
let artist4 = new Artist('Kraftwerk', 'Computer World', 'EMI', 1981, 'images/computerWorld.jpeg', 
